...
public class VermoegenJaehrlichController implements Serializable {
    ...
    private CartesianChartModel vermoegenWachstumJaehrlich;
    private CartesianChartModel vermoegenWachstumJaehrlichProzent;
    ...
    private void init() {
        ...
        Credentials creds = new UsernamePasswordCredentials("haushaltsverwaltung", "ml_AT301437");
    ...
    public void createVermoegenZuwachsJaehrlichChart() {
        this.vermoegenWachstumJaehrlich = new BarChartModel();
        List<VermoegenJaehrlich> vermoegenJaehrlichListe = dao.getAllVermoegenJaehrlich();

        BarChartSeries barGrafik = new BarChartSeries();
        LineChartSeries lineGrafik = new LineChartSeries();
        barGrafik.setLabel("Bar Chart");
        lineGrafik.setLabel("Line Chart");
        for (VermoegenJaehrlich vj : vermoegenJaehrlichListe) {
            barGrafik.set(vj.getJahr().toString(), vj.getDifferenz());
            lineGrafik.set(vj.getJahr().toString(), vj.getDifferenz());
        }

        this.vermoegenWachstumJaehrlich.addSeries(barGrafik);
        this.vermoegenWachstumJaehrlich.addSeries(lineGrafik);
        this.vermoegenWachstumJaehrlich.setTitle("Jährliches Vermögenswachstum (Gewinn) in EURO");
        this.vermoegenWachstumJaehrlich.setLegendPosition("w");
        this.vermoegenWachstumJaehrlich.setMouseoverHighlight(true);
        this.vermoegenWachstumJaehrlich.setShowDatatip(true);
        this.vermoegenWachstumJaehrlich.setShowPointLabels(true);
        Axis yAxis = this.vermoegenWachstumJaehrlich.getAxis(AxisType.Y);
    }
    ...
    public void createVermoegenZuwachsJaehrlichProzentChart() {
        this.vermoegenWachstumJaehrlichProzent = new BarChartModel();
        List<VermoegenJaehrlich> vermoegenJaehrlichListe = dao.getAllVermoegenJaehrlich();

        BarChartSeries barGrafikProzent = new BarChartSeries();
        LineChartSeries lineGrafikProzent = new LineChartSeries();
        barGrafikProzent.setLabel("Bar Chart Prz.");
        lineGrafikProzent.setLabel("Line Chart Prz.");
        for (VermoegenJaehrlich vj : vermoegenJaehrlichListe) {
            barGrafikProzent.set(vj.getJahr().toString(), Double.parseDouble(vj.getProzentZuwachs().toString()));
            lineGrafikProzent.set(vj.getJahr().toString(), Double.parseDouble(vj.getProzentZuwachs().toString()));
        }

        this.vermoegenWachstumJaehrlichProzent.addSeries(barGrafikProzent);
        this.vermoegenWachstumJaehrlichProzent.addSeries(lineGrafikProzent);
        this.vermoegenWachstumJaehrlichProzent.setTitle("Jährliches Vermögenswachstum (Gewinn) in Prozent");
        this.vermoegenWachstumJaehrlichProzent.setLegendPosition("w");
        this.vermoegenWachstumJaehrlichProzent.setMouseoverHighlight(true);
        this.vermoegenWachstumJaehrlichProzent.setShowDatatip(true);
        this.vermoegenWachstumJaehrlichProzent.setShowPointLabels(true);
        Axis yAxis = this.vermoegenWachstumJaehrlichProzent.getAxis(AxisType.Y);
    }
    ...
    public CartesianChartModel getVermoegenWachstumJaehrlich() {
        return vermoegenWachstumJaehrlich;
    }

    public void setVermoegenWachstumJaehrlich(CartesianChartModel vermoegenWachstumJaehrlich) {
    ...
    public CartesianChartModel getVermoegenWachstumJaehrlichProzent() {
        return vermoegenWachstumJaehrlichProzent;
    }

    public void setVermoegenWachstumJaehrlichProzent(CartesianChartModel vermoegenWachstumJaehrlichProzent) {
