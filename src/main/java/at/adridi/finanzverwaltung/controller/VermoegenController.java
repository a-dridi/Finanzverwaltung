...
public class VermoegenController implements Serializable {
    ...
    public void createVermoegenZuwachsMonatlichChart() {
        ...
        LineChartSeries chartserieVermoegen = new LineChartSeries();
        chartserieVermoegen.setFill(true);
        chartserieVermoegen.setLabel("Vermögenswachstum in €");

        //Alle Datumeinträge hinzufügen
        DateFormat df = new SimpleDateFormat("MM.yyyy");
        for (Object[] o : vermoegenwachstumListe) {
            chartserieVermoegen.set(df.format((Date) o[0]), (Number) o[1]);
            // this.gesamtwertEuro += ((Double) o[1]);
            //Speichern von Werten für Zuwachsberechnung (zwischen Alt und Neu Wert
        }
        this.vermoegenWachstumMonatlich.addSeries(chartserieVermoegen);
        this.vermoegenWachstumMonatlich.setTitle("Vermögenswachstum (Gewinn) in EURO pro Monat");
        this.vermoegenWachstumMonatlich.setAnimate(true);
        this.vermoegenWachstumMonatlich.setLegendPosition("w");
        this.vermoegenWachstumMonatlich.setMouseoverHighlight(true);
        this.vermoegenWachstumMonatlich.setShowPointLabels(true);
        this.vermoegenWachstumMonatlich.setZoom(true);

        Axis xaxis = new CategoryAxis("Monate");
        this.vermoegenWachstumMonatlich.getAxes().put(AxisType.X, xaxis);
        Axis yAxis = this.vermoegenWachstumMonatlich.getAxis(AxisType.Y);
        yAxis.setLabel("Ertrag in Euro");
        this.vermoegenWachstumMonatlich.getAxes().put(AxisType.Y, yAxis);
    ...
    public void createVermoegenZuwachsMonatlichProzentChart() {
        ...
        LineChartSeries chartserieVermoegen = new LineChartSeries();
        chartserieVermoegen.setFill(true);
        chartserieVermoegen.setLabel("Vermögenswachstum in Prozent");
        ...
        this.vermoegenWachstumMonatlichProzent.addSeries(chartserieVermoegen);
        this.vermoegenWachstumMonatlichProzent.setTitle("Vermögenswachstum (Gewinn) in Prozent pro Monat");
        this.vermoegenWachstumMonatlichProzent.setAnimate(true);
        this.vermoegenWachstumMonatlichProzent.setLegendPosition("w");
        this.vermoegenWachstumMonatlichProzent.setMouseoverHighlight(true);
        this.vermoegenWachstumMonatlichProzent.setShowPointLabels(true);
        this.vermoegenWachstumMonatlichProzent.setZoom(true);

        Axis xaxis = new CategoryAxis("Monate");
        this.vermoegenWachstumMonatlichProzent.getAxes().put(AxisType.X, xaxis);
        Axis yAxis = this.vermoegenWachstumMonatlichProzent.getAxis(AxisType.Y);
        yAxis.setLabel("Wachstum in Prozent");
        this.vermoegenWachstumMonatlichProzent.getAxes().put(AxisType.Y, yAxis);
